...
//Code Here
let totalPopulation = populations.reduce((total, elem, index) => {
  return total += populations[index]
}, 0)
...
//Code Here
let myStrongest = monstersInYourPocket.filter((e, i) => monstersInYourPocket[i].CP > 200)
...
let bobsTotal = purchases.filter(e => e.owner === 'Bob').reduce((total, e) => {
